...
async def subscribe(
        channel_id: int, repository=Depends(get_repository_service),
        customer=Depends(get_customer)
):
    return await ChannelPresenter(**repository) \
        .subscribe(channel_id=channel_id, customer_id=customer.id)
...
async def delete_channel(
    ...
    return await ChannelPresenter(**repository) \
        .delete_channel(customer_id=customer.id, channel_id=channel_id)
...
async def update_channel(
    ...
    return await ChannelPresenter(**repository) \
        .update_channel(updated_data=updated_data, channel_id=channel_id,
...
async def get_channel(
    ...
    return await ChannelPresenter(**repository).get_channel(channel_id=channel_id)
